...
const MapComponent: React.FC<MapComponentProps> = ({
  ...
  const { isOpen, data, x, y, isDetailsModalOpen, setDetailsModalOpen, selectedRow, setSelectedRow, reportData, surveyData, setSurveyData, surveyImages, setSurveyImages, planSet, setPlanSet, updateMapCoordinates, selectedPointId, setSelectedPointId, filteredData, setFilteredData } = useModal();
  ...
  useEffect(() => {
    ...
    // Create graphics layer for custom markers
  ...
  useEffect(() => {
    ...
    // Ensure x and y are numbers before proceeding
    if (x !== null && y !== null) {
      // Add the flickering marker at the selected coordinates
